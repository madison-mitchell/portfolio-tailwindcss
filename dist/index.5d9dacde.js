...
function renderHome() {
    app.innerHTML = _homeJsDefault.default();
    renderProjects();
}
function navHome() {
...
},{"./components/Home.js":"4qI8a","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./components/Projects.js":"e48wQ"}],"4qI8a":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _animateCss = require("animate.css");
var _memojiSmilePng = require("../../assets/memoji-smile.png");
var _memojiSmilePngDefault = parcelHelpers.interopDefault(_memojiSmilePng);
var _memojiLaptopPng = require("../../assets/memoji-laptop.png");
var _memojiLaptopPngDefault = parcelHelpers.interopDefault(_memojiLaptopPng);
var _memojiWavePng = require("../../assets/memoji-wave.png");
var _memojiWavePngDefault = parcelHelpers.interopDefault(_memojiWavePng);
function Home() {
    return `
        ...
        <div
            ...
            <div class="projects-grid grid grid-cols-3 gap-x-5">
                ...
                <div class="image flex justify-center">
                    <img src="${_memojiLaptopPngDefault.default}" alt="" class="memoji">
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="header" class="flex justify-around animate__animated animate__zoomIn">
        <div
            ...
            <div class="image flex justify-center">
                <img src="${_memojiSmilePngDefault.default}" alt="" class="memoji">
            </div>
    ...
    <div id="contact" class="flex justify-around animate__animated animate__zoomIn">
        <div
            ...
            <div class="image flex justify-center">
                <img src="${_memojiWavePngDefault.default}" alt="" class="memoji">
            </div>
        </div>
    </div>
    `;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../../assets/memoji-smile.png":"5BNic","../../assets/memoji-laptop.png":"iPl7w","../../assets/memoji-wave.png":"aW3AC","animate.css":"8t3va"}],"gkKU3":[function(require,module,exports) {
...
},{}],"5BNic":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('ksUvU') + "memoji-smile.386d6a73.png" + "?" + Date.now();
...
},{}],"iPl7w":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('ksUvU') + "memoji-laptop.acb4f903.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"aW3AC":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('ksUvU') + "memoji-wave.7d4bbe5a.png" + "?" + Date.now();
